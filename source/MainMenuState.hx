...
class MainMenuState extends MusicBeatState
{
	...
	public static var kadeEngineVer:String = "1.5.4 //-Hippo Boi made with"+ nightly;
	...
	override function create()
	{
		...
		var bgCity:FlxSprite = new FlxSprite(-100,-829).loadGraphic(Paths.image('BG_BENCH', 'camelliaweek'));
		...
		var logoBl = new FlxSprite(85, -600);
		logoBl.frames = Paths.getSparrowAtlas('logoBumpin');
		logoBl.antialiasing = true;
		logoBl.animation.addByPrefix('bump', 'logo bumpin', 24);
		logoBl.animation.play('bump');
		// logoBl.scrollFactor.set(0.1, 0);
		logoBl.setGraphicSize(Std.int(logoBl.width * 0.58));
		logoBl.updateHitbox();
		logoBl.screenCenter(X);
		add(logoBl);

		funny = new FlxSprite(0,900).loadGraphic(Paths.image('clean', 'camelliaweek'));
		...
		funnyText = new FlxText(0, -120, 0, "pestymelac-", 64);
