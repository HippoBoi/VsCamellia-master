...
class PlayState extends MusicBeatState
{
	...
	var camelliaCity:FlxTypedGroup<FlxSprite>;
	var camelliaWall:FlxTypedGroup<FlxSprite>;
	var camelliaFloor:FlxTypedGroup<FlxSprite>;
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'rude-blaster':
				dialogue = CoolUtil.coolTextFile(Paths.txt('rude-blaster/dialogue'));
			case 'rude-blaster-cam':
				dialogue = CoolUtil.coolTextFile(Paths.txt('rude-blaster-cam/dialogue'));
		}
		if(_camsave.data.cmode)
		{
			switch(songLowercase)
			{
				...
				case 'rude-blaster':
					dialogue = CoolUtil.coolTextFile(Paths.txt('rude-blaster/dialogue-c'));
				case 'rude-blaster-cam':
					dialogue = CoolUtil.coolTextFile(Paths.txt('rude-blaster-cam/dialogue-c'));
			}
		}
		...
		switch (stageCheck)
		{
			...
			case "camellia":
				...
				//CAMELLIA CITY BACK
				camelliaCity = new FlxTypedGroup<FlxSprite>();
					if (FlxG.save.data.distractions)
					{
						add(camelliaCity);
					}
					...
					for (i in 0...5)
					{
						var camCity:FlxSprite = new FlxSprite(-650, -400).loadGraphic(Paths.image('BG_BENCH', 'camelliaweek'));
						camCity.scrollFactor.set(0.5, 0.5);
						camCity.scale.set(1.55, 1.55);
					    camCity.antialiasing = true;
						camCity.visible = true;
						camCity.updateHitbox();
						camelliaCity.add(camCity);
					}
				//CAMELLIA WALL BACK
				camelliaWall = new FlxTypedGroup<FlxSprite>();
					if (FlxG.save.data.distractions)
					{
						add(camelliaWall);
					}
					...
					for (i in 0...5)
					{
						var camWall:FlxSprite = new FlxSprite(-650, -400).loadGraphic(Paths.image('BG_WALL', 'camelliaweek'));
						camWall.scrollFactor.set(1, 1);
						camWall.scale.set(1.55, 1.55);
					    camWall.antialiasing = true;
						camWall.visible = true;
						camWall.updateHitbox();
						camelliaWall.add(camWall);
					}
				//CAMELLIA FLOOR BACK
				camelliaFloor = new FlxTypedGroup<FlxSprite>();
					if (FlxG.save.data.distractions)
					{
						add(camelliaFloor);
					}
					...
					for (i in 0...5)
					{
						var camFloor:FlxSprite = new FlxSprite(-650, -400).loadGraphic(Paths.image('FG_Floor', 'camelliaweek'));
						camFloor.scrollFactor.set(0.9, 0.9);
						camFloor.scale.set(1.55, 1.55);
					    camFloor.antialiasing = true;
						camFloor.visible = true;
						camFloor.updateHitbox();
						camelliaFloor.add(camFloor);
					}
			...
			case "camellia2":
				...
				camelliaCity = new FlxTypedGroup<FlxSprite>();
					...
					for (i in 0...5)
					{
						var camCity:FlxSprite = new FlxSprite(-650, -400).loadGraphic(Paths.image('BG_CITY', 'camelliaweek'));
						camCity.scrollFactor.set(0.5, 0.5);
						camCity.scale.set(1.55, 1.55);
					    camCity.antialiasing = true;
						camCity.visible = true;
			...
			default:
				...
				camelliaCity = new FlxTypedGroup<FlxSprite>();
					...
					for (i in 0...5)
					{
						var camCity:FlxSprite = new FlxSprite(-250, -100).loadGraphic(Paths.image('BG_CITY', 'camelliaweek'));
						camCity.scrollFactor.set(0.5, 0.5);
						camCity.scale.set(1.55, 1.55);
					    camCity.antialiasing = true;
						camCity.visible = true;
				...
				camelliaWall = new FlxTypedGroup<FlxSprite>();
					...
					for (i in 0...5)
					{
						var camWall:FlxSprite = new FlxSprite(-250, -100).loadGraphic(Paths.image('BG_WALL', 'camelliaweek'));
						camWall.scrollFactor.set(1, 1);
						camWall.scale.set(1.55, 1.55);
					    camWall.antialiasing = true;
						camWall.visible = true;
				...
				camelliaFloor = new FlxTypedGroup<FlxSprite>();
					...
					for (i in 0...5)
					{
						var camFloor:FlxSprite = new FlxSprite(-250, -100).loadGraphic(Paths.image('FG_Floor', 'camelliaweek'));
						camFloor.scrollFactor.set(0.9, 0.9);
						camFloor.scale.set(1.55, 1.55);
					    camFloor.antialiasing = true;
						camFloor.visible = true;
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - KE 1.5.4    -Hippo_Boii" : ""), 16);
		if (_camsave.data.cmode && _camsave.data.modcharts){kadeEngineWatermark.text = SONG.song + " " + (storyDifficulty == 5 ? "Hard" : storyDifficulty == 4 ? "Normal" : "Easy") + " C-MODE" + " w/ Modcharts" + (Main.watermarks ? " - KE 1.5.4    -Hippo_Boii" : "");}
		else if(_camsave.data.cmode && !_camsave.data.modcharts){kadeEngineWatermark.text = SONG.song + " " + (storyDifficulty == 5 ? "Hard" : storyDifficulty == 4 ? "Normal" : "Easy") + " C-MODE" + (Main.watermarks ? " - KE 1.5.4    -Hippo_Boii": "");}
		else if(!_camsave.data.cmode && _camsave.data.modcharts){kadeEngineWatermark.text = SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + " w/ Modcharts" + (Main.watermarks ? " - KE 1.5.4    -Hippo_Boii" : "");}
		else if(!_camsave.data.cmode && !_camsave.data.modcharts){kadeEngineWatermark.text = SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - KE 1.5.4    -Hippo_Boii" : "");}
		...
		if (isStoryMode)
		{
			switch (StringTools.replace(curSong, " ", "-").toLowerCase())
			{
				...
				case 'thorns':
					schoolIntro(doof);
				case 'first-town' | 'liquated' | 'why-do-you-hate-me' | 'ghost' | 'rude-blaster' | 'rude-blaster-cam':
		...
		for (section in noteData)
		{
			...
			for (songNotes in section.sectionNotes)
			{
				...
				if (SONG.song.toLowerCase() == "first-town"
					...
					|| SONG.song.toLowerCase() == "rude-blaster"
					|| SONG.song.toLowerCase() == "rude-blaster-cam")
				{
					daStrumTime += 30;
				}
				if (daStrumTime < 0)
	...
	override function beatHit()
	{
		...
		//CAMELLIA RUDE BLASTER MID SONG STUFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
		
		if (curBeat % 4 == 8 && curSong == 'rude-blaster')
		{
			defaultCamZoom = 1.1;
		}
		
		if (curBeat % 6 == 10 && curSong == 'rude-blaster')
		{
			defaultCamZoom = 0.3;
		}
		
		if (curBeat % 4 == 8 && curSong == 'rude-blaster' && curBeat > 1072 && curBeat < 1142)
		{
			defaultCamZoom = 0.7;
		}
		
		if (curBeat % 6 == 10 && curSong == 'rude-blaster' && curBeat > 1072 && curBeat < 1142)
		{
			defaultCamZoom = 0.5;
		}
		
		if (curBeat == 924 && curSong == 'rude-blaster')
		{
			defaultCamZoom = 0.6;
		}
		
		if (curBeat == 924 && curSong == 'rude-blaster-cam')
		{
			defaultCamZoom = 0.6;
		}
		
		if (curBeat == 928 && curSong == 'rude-blaster')
		{
			defaultCamZoom = 0.3;
			//let room black
			camelliaCity.forEach(function(camCity:FlxSprite)
			{
				camCity.visible = false;
			});
			
			camelliaWall.forEach(function(camWall:FlxSprite)
			{
				camWall.visible = false;
			});
			
			camelliaFloor.forEach(function(camFloor:FlxSprite)
			{
				camFloor.visible = false;
			});
		}
		
		if (curBeat == 928 && curSong == 'rude-blaster-cam')
		{
			defaultCamZoom = 0.3;
			//let room black
			camelliaCity.forEach(function(camCity:FlxSprite)
		...
		if (curBeat == 956 && curSong == 'rude-blaster')
		{
			defaultCamZoom = 0.5;
		}
		
		if (curBeat == 956 && curSong == 'rude-blaster-cam')
		{
			defaultCamZoom = 0.5;
		}
		
		if (curBeat == 958 && curSong == 'rude-blaster')
		{
			//let room normal again lmao
			camelliaCity.forEach(function(camCity:FlxSprite)
			{
				camCity.visible = true;
			});
		...
		if (curBeat == 958 && curSong == 'rude-blaster-cam')
		{
			//let room normal again lmao
			camelliaCity.forEach(function(camCity:FlxSprite)
			{
		...
		if (curBeat == 1008 && curSong == 'rude-blaster')
		{
			defaultCamZoom = 0.7;
		}
		
		if (curBeat == 1040 && curSong == 'rude-blaster')
		{
			defaultCamZoom = 0.5;
		}
