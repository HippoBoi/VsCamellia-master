...
class StoryMenuState extends MusicBeatState
{
	...
	public static var weekUnlocked:Array<Bool> = [true, false, true, true]; //, true, true, true, true, true, true, true];
	...
	override function create()
	{
		...
		{
			weekCharacters = [['bf', 'camellia', 'gf'],['bf', 'camellia', 'gf'], ['bf', 'camellia', 'gf'], ['camellia', 'bf', 'gf']];
		}
